...
class _AdminForgotpasswordscreenState extends State<AdminForgotpasswordscreen> {
  ...
  Future <void> postForgotPassword ()async{
    ...
    try {
      final response = await http.post(Uri.parse("$BaseUrl/admin/auth/forgot-password"),
      ...
      if(response.statusCode==200){
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context) => AdminOTPScreen(registeredEmail: registeredEmailController.text.toLowerCase().trim().toString(),reason: "forgotpassword",),));
